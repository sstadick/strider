...
vim.api.nvim_create_user_command("SherpaNext", function(opts)
  require("sherpa").next_step(opts.bang)
end, { bang = true, desc = "Advance to the next Sherpa review item; ! accepts the current stop first" })
...
end, { desc = "Open the Sherpa status surface" })
